    ...
    14: SceneGroup("MUSE",
        [
            Scene("Select", init_patch=Discard(), patch=Discard()),
            Scene("Assassin", init_patch=MixToAfxOff // P01A, patch=p_muse),
            Scene("Hysteria", init_patch=MixToAfxOff  // P01A, patch=p_muse),
            Scene("Cydonia",  init_patch=MixToAfxOff// P01A, patch=p_muse),
            Scene("Starlight", init_patch=MixToAfxOff // P01A, patch=p_muse),
            Scene("Stockholm", init_patch=MixToAfxOff // P01A, patch=p_muse),
        ]),
