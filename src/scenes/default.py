    ...
    14: SceneGroup("MUSE",
        [
            Scene("Select", init_patch=Discard(), patch=Discard()),
            Scene("Assassin", init_patch=MasteringEffectOff // P01A, patch=p_muse),
            Scene("Hysteria", init_patch=MasteringEffectOff  // P01A, patch=p_muse),
            Scene("Cydonia",  init_patch=MasteringEffectOff// P01A, patch=p_muse),
            Scene("Starlight", init_patch=MasteringEffectOff // P01A, patch=p_muse),
            Scene("Stockholm", init_patch=MasteringEffectOff // P01A, patch=p_muse),
        ]),
