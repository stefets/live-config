    ...
    8: SceneGroup("Majestyx",
        [
            Scene("Select", init_patch=Discard(), patch=Discard()),
            Scene("Setlist", init_patch=Call(Playlist())//U01_A, patch=Discard()),
        ]),
    ...
    15: SceneGroup("MajestyxLive",
        [
            Scene("Select", init_patch=Discard(), patch=Discard()),
            Scene("01", init_patch = NoteOn(0, 0)  >> VLC, patch =Pass() ),
            Scene("02", init_patch = NoteOn(1, 0)  >> VLC, patch =Pass() ),
            Scene("03", init_patch = NoteOn(2, 0)  >> VLC, patch =Pass() ),
            Scene("04", init_patch = NoteOn(3, 0)  >> VLC, patch =Pass() ),
            Scene("05", init_patch = NoteOn(4, 0)  >> VLC, patch =Pass() ),
            Scene("06", init_patch = NoteOn(5, 0)  >> VLC, patch =Pass() ),
            Scene("07", init_patch = NoteOn(6, 0)  >> VLC, patch =Pass() ),
            Scene("08", init_patch = NoteOn(7, 0)  >> VLC, patch =Pass() ),
            Scene("09", init_patch = NoteOn(8, 0)  >> VLC, patch =Pass() ),
            Scene("10", init_patch = NoteOn(9, 0)  >> VLC, patch =Pass() ),
            Scene("11", init_patch = NoteOn(10, 0) >> VLC, patch =Pass() ),
            Scene("12", init_patch = NoteOn(11, 0) >> VLC, patch =Pass() ),
            Scene("13", init_patch = NoteOn(12, 0) >> VLC, patch =Pass() ),
            Scene("14", init_patch = NoteOn(13, 0) >> VLC, patch =Pass() ),
            Scene("15", init_patch = NoteOn(14, 0) >> VLC, patch =Pass() ),
            Scene("16", init_patch = NoteOn(15, 0) >> VLC, patch =Pass() ),
            Scene("17", init_patch = NoteOn(16, 0) >> VLC, patch =Pass() ),
            Scene("18", init_patch = NoteOn(17, 0) >> VLC, patch =Pass() ),
            Scene("19", init_patch = NoteOn(18, 0) >> VLC, patch =Pass() ),
            Scene("20", init_patch = NoteOn(19, 0) >> VLC, patch =Pass() ),
            Scene("21", init_patch = NoteOn(20, 0) >> VLC, patch =Pass() ),
            Scene("22", init_patch = NoteOn(21, 0) >> VLC, patch =Pass() ),
            Scene("23", init_patch = NoteOn(22, 0) >> VLC, patch =Pass() ),
            Scene("24", init_patch = NoteOn(23, 0) >> VLC, patch =Pass() ),
            Scene("25", init_patch = NoteOn(24, 0) >> VLC, patch = Pass ()),
        ]),    
    16:  SceneGroup("Libre",
        [
            Scene("Select", init_patch=Discard(), patch=Discard()),
