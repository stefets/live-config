...
_scenes = {
    ...
    15: SceneGroup("MajestyxLive", [
            Scene("STOP", init_patch = NoteOn(46, 0) >> VLC, patch = Discard()),
            Scene("INTERLUDE", init_patch = NoteOn(0, 0) >> VLC, patch = Pass()),
            Scene("01-Rockin Paradise", init_patch = NoteOn(1, 0) >> VLC, patch = Pass()),
            Scene("02-BlueCollarMan", init_patch = NoteOn(2, 0) >> VLC, patch = Pass()),
            Scene("03-Lorelei", init_patch = NoteOn(3, 0) >> VLC, patch = Pass()),
            Scene("04-Too Much Time", init_patch = NoteOn(4, 0) >> VLC, patch = Pass()),
            Scene("05-Snowblind", init_patch = NoteOn(5, 0) >> VLC, patch = Pass()),
            Scene("06-Come Sail Away", init_patch = NoteOn(6, 0) >> VLC, patch = Pass()),
            Scene("07-Queen Of Spades", init_patch = NoteOn(7, 0) >> VLC, patch = Pass()),
            Scene("08-Light Up", init_patch = NoteOn(8, 0) >> VLC, patch = Pass()),
            Scene("09-The Best of Time", init_patch = NoteOn(9, 0) >> VLC, patch = Pass()),
            Scene("10-Lady", init_patch = NoteOn(10, 0) >> VLC, patch = Pass()),
            Scene("11-Fooling Yourself", init_patch = NoteOn(11, 0) >> VLC, patch = Pass()),
            Scene("12-Roboto", init_patch = NoteOn(12, 0) >> VLC, patch = Pass()),
            Scene("13-Show Me The Way", init_patch = NoteOn(13, 0) >> VLC, patch = Pass()),
            Scene("14-Lights", init_patch = NoteOn(14, 0) >> VLC, patch = Pass()),
            Scene("15-Pieces Of Eight", init_patch = NoteOn(15, 0) >> VLC, patch = Pass()),
            Scene("16-I’m Ok", init_patch = NoteOn(16, 0) >> VLC, patch = Pass()),
            Scene("17-Miss America", init_patch = NoteOn(17, 0) >> VLC, patch = Pass()),
            Scene("18-Babe", init_patch = NoteOn(18, 0) >> VLC, patch = Pass()),
            Scene("19-Renegade", init_patch = NoteOn(19, 0) >> VLC, patch = Pass()),
            Scene("20-Crystal Ball", init_patch = NoteOn(20, 0) >> VLC, patch = Pass()),
            Scene("21-Grand Illusion", init_patch = NoteOn(21, 0) >> VLC, patch = Pass()),
            Scene("22-BoatOnThRiver", init_patch = NoteOn(22, 0) >> VLC, patch = Pass()),
            Scene("23-SuiteMadameBlue", init_patch = NoteOn(23, 0) >> VLC, patch = Pass()),
            Scene("Repeat-ON", init_patch = NoteOn(47, 0) >> VLC, patch = Pass()),
            Scene("Repeat-OFF", init_patch = NoteOn(48, 0) >> VLC, patch = Pass ()),
        ]),    
